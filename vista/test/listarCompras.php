            ...
            <?php if ($hayUsuarios): ?>
                <table class="table">
                    ...
                    for ($i = 0; $i < count($colCompras); $i++):
                        $idusuario = $colCompras[$i]->getIdUsuario();
                        $usnombre = $colCompras[$i]->getUsNombre();
                        $usmail = $colCompras[$i]->getUsMail();

                        // Creo instancia del objeto AbmCompraRol para mostrar los roles de los usuarios
                        $objUsuarioRol = new AbmCompraRol();
                        ...
                        $usdeshabilitado = $colCompras[$i]->getUsDeshabilitado();
