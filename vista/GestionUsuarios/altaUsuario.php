    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formAlta" name="form" method="post" action="accion/altaUsuario.php">
                    <div class="mb-1">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" id="usmailAlta" name="usmailAlta">
                            <div class="mensaje-error"></div>
                        </div>
                        <div class="mb-1">
                            <label for="uspass">Contraseña</label>
                            <div class="input-group">
                                <input type="password" class="form-control" id="uspassAlta" name="uspassAlta">
