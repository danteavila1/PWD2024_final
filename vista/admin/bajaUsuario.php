<div aria-hidden="true" class="modal fade" id="bajaUsuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="form" method="post" action="accion/bajaUsuario.php">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">ID</th>
